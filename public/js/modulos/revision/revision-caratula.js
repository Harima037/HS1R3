			...
			for(var cuentaComponentes in response.data.componentes)
			{
				...
				if(cuantasActividades > 0)
				{
					for(var indiceActividad in response.data.componentes[cuentaComponentes].actividades)
					{
						...
						PanelDeActividades[contadorDeActividades] = PanelDeActividades[contadorDeActividades] + '<div class="col-sm-12"><div class="form-group"><label class="control-label" for="lbl-descripcionactividad'+idActividad+'">Descripción</label><div class="input-group"><span class="input-group-btn" onclick="escribirComentarioActividad(\'descripcion|'+idActividad+'\',\'Descripción\',\'lbl-descripcionactividad'+idActividad+'\');"><span class="btn btn-default"><i class="fa fa-pencil-square-o"></i></span></span><p id="lbl-descripcionactividad'+idActividad+'" class="form-control" style="height:auto">'+response.data.componentes[cuentaComponentes].actividades[indiceActividad].objetivo+'</p></div></div></div>';		
						
						PanelDeActividades[contadorDeActividades] = PanelDeActividades[contadorDeActividades] + '<div class="col-sm-12"><div class="form-group"><label class="control-label" for="lbl-mediosverificacionactividad'+idActividad+'">Medios de verificación</label><div class="input-group"><span class="input-group-btn" onclick="escribirComentarioActividad(\'mediosverificacion|'+idActividad+'\',\'Medios de Verificación\',\'lbl-mediosverificacionactividad'+idActividad+'\');"><span class="btn btn-default"><i class="fa fa-pencil-square-o"></i></span></span><p id="lbl-mediosverificacionactividad'+idActividad+'" class="form-control" style="height:auto">'+response.data.componentes[cuentaComponentes].actividades[indiceActividad].mediosVerificacion+'</p></div></div></div>';				
						...
						PanelDeActividades[contadorDeActividades] = PanelDeActividades[contadorDeActividades] + '<div class="col-sm-6"><div class="form-group"><label class="control-label" for="lbl-numeradoractividad'+idActividad+'">Numerador</label><div class="input-group"><span class="input-group-btn" onclick="escribirComentarioActividad(\'numerador|'+idActividad+'\',\'Numerador\',\'lbl-numeradoractividad'+idActividad+'\');"><span class="btn btn-default"> <i class="fa fa-pencil-square-o"></i></span></span><p id="lbl-numeradoractividad'+idActividad+'" class="form-control" style="height:auto">'+response.data.componentes[cuentaComponentes].actividades[indiceActividad].numerador+'</p></div></div></div>';
						PanelDeActividades[contadorDeActividades] = PanelDeActividades[contadorDeActividades] + '<div class="col-sm-6"><div class="form-group"><label class="control-label" for="lbl-denominadoractividad'+idActividad+'">Denominador</label><div class="input-group"><span class="input-group-btn" onclick="escribirComentarioActividad(\'denominador|'+idActividad+'\',\'Denominador\',\'lbl-denominadoractividad'+idActividad+'\');"><span class="btn btn-default"> <i class="fa fa-pencil-square-o"></i></span></span><p id="lbl-denominadoractividad'+idActividad+'" class="form-control" style="height:auto">'+response.data.componentes[cuentaComponentes].actividades[indiceActividad].denominador+'</p></div></div></div>';
						...
						if(response.data.componentes[cuentaComponentes].actividades[indiceActividad].tipo_indicador == null){
							PanelDeActividades[contadorDeActividades] = PanelDeActividades[contadorDeActividades] + '<div class="col-sm-3"><div class="form-group"><label class="control-label" for="lbl-tipoactividad'+idActividad+'">Tipo</label><div class="input-group"><span class="input-group-btn" onclick="escribirComentarioActividad(\'tipo|'+idActividad+'\',\'Tipo\',\'lbl-tipoactividad'+idActividad+'\');"><span class="btn btn-default"> <i class="fa fa-pencil-square-o"></i></span></span><p id="lbl-tipoactividad'+idActividad+'" class="form-control" style="height:auto"></p></div></div></div>';
						}else{
						...
						if(response.data.componentes[cuentaComponentes].actividades[indiceActividad].unidad_medida == null){
							PanelDeActividades[contadorDeActividades] = PanelDeActividades[contadorDeActividades] + '<div class="col-sm-5"><div class="form-group"><label class="control-label" for="lbl-unidadmedidaactividad'+idActividad+'">Unidad de medida</label><div class="input-group"><span class="input-group-btn" onclick="escribirComentarioActividad(\'unidadmedida|'+idActividad+'\',\'Unidad de medida\',\'lbl-unidadmedidaactividad'+idActividad+'\');"><span class="btn btn-default"> <i class="fa fa-pencil-square-o"></i></span></span><p id="lbl-unidadmedidaactividad'+idActividad+'" class="form-control" style="height:auto"></p></div></div></div>';
						}else{
