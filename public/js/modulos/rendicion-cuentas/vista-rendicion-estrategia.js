/*=====================================
    ...
    # Nombre:
        vista-rendicion-estrategia.js

    # Módulo:
        seguimiento/avance-estrategia
...
$('#btn-estrategia-cancelar').on('click',function(){
    window.location.href = SERVER_HOST+'/rendicion-cuentas/rend-cuenta-estra';
});
...
$('#btn-enviar-estrategia').on('click',function(){
    ...
    Confirm.show({
        ...
        mensaje: "¿Estás seguro que deseas enviar este avance para su validación? <br><b>IMPORTANTE:</b> Mientras la estrategia institucional este en validación no se podra editar.",
...
if($('#id').val()){
    var parametros = {mostrar:'datos-estrategia-presupuestario'};
...
$('#btn-guardar-avance').on('click',function(){
    ...
    parametros += '&guardar=avance-metas&id-estrategia='+$('#id').val();
