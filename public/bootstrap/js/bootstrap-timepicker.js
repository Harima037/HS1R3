...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      if (this.showInputs) {
        hourTemplate = '<div class="input-group"><input type="text" name="hour" class="bootstrap-timepicker-hour form-control" maxlength="2"/></div>';
        minuteTemplate = '<div class="input-group"><input type="text" name="minute" class="bootstrap-timepicker-minute form-control" maxlength="2"/></div>';
        secondTemplate = '<div class="input-group"><input type="text" name="second" class="bootstrap-timepicker-second form-control" maxlength="2"/></div>';
        meridianTemplate = '<div class="input-group"><input type="text" name="meridian" class="bootstrap-timepicker-meridian form-control" maxlength="2"/></div>';
      } else {
