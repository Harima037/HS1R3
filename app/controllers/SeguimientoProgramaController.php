...
class SeguimientoProgramaController extends BaseController {
	...
	public function index(){
		...
		return parent::loadIndex('REVISION','SEGUIPROG',$datos);
	}
	...
	public function editarAvance($id){
		...
		$datos['sys_mod_activo'] = SysModulo::findByKey('SEGUIPROG');
		$permiso = 'REVISION.SEGUIPROG.R';
		
		$uri = 'revision.vista-captura-rendicion-programa';
