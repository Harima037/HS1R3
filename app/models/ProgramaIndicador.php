...
class ProgramaIndicador extends BaseModel
{
	...
	public function scopeContenidoDetalle($query){
		$query->select('programaIndicador.*','dimensiones.descripcion as dimensionIndicador','tipos.descripcion as tipoIndicador','unidades.descripcion AS unidadMedida','formulas.descripcion AS formula','frecuencias.descripcion as frecuencia')
