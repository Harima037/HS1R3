	...
	<div class="col-md-12">
		<div class="panel panel-default datagrid">
	        ...
	        <div class="panel-body">
				...
				<p>Prueba regresando al <a href="{{ URL::to('/') }}"><span class="glyphicon glyphicon-dashboard"></span> Dashboard</a> o visita la sección de <a href="#modalAyuda" data-toggle="modal"><span class="glyphicon glyphicon-question-sign"></span> Ayuda</a></p>		                     
		    </div> 
		</div>
	</div>
</div> 	
