...
<script src="{{ URL::to('js/modulos/reportes/reporte-proyectos-evaluacion.js') }}"></script>
@stop
    ...
    <div class="modal-dialog modal-dialog-85-screen">
        <div class="modal-content modal-content-85-screen">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalLabel"><span id="accion-evaluacion"></span> Evaluación</h4>
            </div>
            <table id="tabla-lista-indicadores" class="table table-hover table-striped">
                <thead>
                    <tr>
                        <th>Nivel</th>
                        <th>Indicador</th>
                        <th width="15%">Meta<br>Programada</th>
                        <th width="15%">Avance<br>Acumulado</th>
                ...
                <tfoot>
                    <tr>
                        <td colspan="2"><strong>Presupuesto autorizado:</strong> <span id="presupuesto-autorizado"></span></td>
                        <td colspan="3"><strong>Presupuesto ejercido:</strong> <span id="presupuesto-ejercido"></span></td>
                    </tr>
                </tfoot>
            </table>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="justificaciones" id="justificaciones" rows="8"></textarea>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
