...
<script src="{{ URL::to('js/modulos/reportes/ficha-tecnica-evaluacion.js') }}"></script>
@stop
                        ...
                        <div class="btn-toolbar pull-right" >
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary btn-edit-rows">
                                    <span class="fa fa-pencil"></span> Ver Datos Proyecto
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <p class="form-control-static" id="clave"></p>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <p class="form-control-static" id="programa"></p>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="control-label">Finalidad del Proyecto</label>
                                    <p class="form-control-static" id="finalidad"></p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <p class="form-control-static" id="autorizado"></p>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label class="control-label">Presupuesto Modificado</label>
                                    <p class="form-control-static" id="modificado"></p>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label class="control-label">Presupuesto Devengado</label>
                                    <p class="form-control-static" id="devengado"></p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="control-label">Fuente de Financiamiento</label>
                                    <p class="form-control-static" id="fuente_financiamiento"></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>Indicador</th>
                                    <th width="100px">Programado Anual</th>
                                    <th width="100px">Programado al Trimestre</th>
                                    <th width="100px">Alcanzado al Trimestre</th>
                                    <th width="100px">% Avance Anual</th>
                                    <th width="100px">% Avance al Trimestre</th>
                                </tr>
                            </thead>
                            <tbody id="indicadores" class="rows-texto-completo"></tbody>
                        </table>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <p class="form-control-static" id="evaluacion"></p>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <p class="form-control-static" id="justificacion"></p>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label class="control-label">Plan de Acción de Mejora:</label>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                            <p class="form-control-static" id="plan_accion_mejora"></p>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <textarea id="recomendacion" class="form-control"></textarea>
                        </div>
                        <input type="hidden" id="variable_id">
                        <input type="hidden" id="variable_tipo">
                        <input type="hidden" id="variable_id_plan">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <!--div id="btn-reporte" class="pull-left">
                    <button type="button" class="btn btn-info disabled" id="btn-excel"><span class="fa fa-file-excel-o"></span> Imprimir</button>
                </div-->
