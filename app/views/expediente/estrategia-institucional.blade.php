...
<script src="{{ URL::to('js/modulos/expediente/estrategia-institucional.js')}}"></script>
@stop
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default datagrid" id="datagridEstrategia" data-edit-row="cargar_datos_estrategia">
