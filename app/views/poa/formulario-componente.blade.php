<form action="" id="form_{{$identificador}}">
    <ul class="nav {{(isset($lista_actividades))?'nav-tabs':'nav-pills'}}" role="tablist">
        ...
        <li role="presentation">
            <a href="#actividades_{{$identificador}}" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="objetivos_{{$identificador}}">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="tipoobj{{$identificador}}" class="control-label">Tipo</label>
                        <input type="text" class="form-control" id="tipoobj{{$identificador}}" name="tipoobj{{$identificador}}">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label for="descripcionobj{{$identificador}}" class="control-label">Descripción</label>
                        <input type="text" class="form-control" id="descripcionobj{{$identificador}}" name="descripcionobj{{$identificador}}">
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="descripcionind{{$identificador}}" class="control-label">Descripción</label>
                                <input type="text" class="form-control" id="descripcionind{{$identificador}}" name="descripcionind{{$identificador}}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="numeradorind{{$identificador}}" class="control-label">Numerador</label>
                                <input type="text" class="form-control" id="numeradorind{{$identificador}}" name="numeradorind{{$identificador}}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="denominadorind{{$identificador}}" class="control-label">Denominador</label>
                                <input type="text" class="form-control" id="denominadorind{{$identificador}}" name="denominadorind{{$identificador}}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div clasS="form-group">
                                <label class="control-label" for="tipoind{{$identificador}}">
                                    Tipo
                                </label>
                                {{Form::select('tipoind'.$identificador,array(''=>'Seleccione un tipo') + $tipos_indicador->lists('descripcion','id'),'',array('class'=>'form-control selectpicker','id'=>'tipoind'.$identificador))}}
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div clasS="form-group">
                                <label class="control-label" for="unidadmedida{{$identificador}}">
                                    Unidad de Medida
                                </label>
                                {{Form::select('unidadmedida'.$identificador,array(''=>'Seleccione una unidad') + $unidades_medida->lists('descripcion','id'),'',array('class'=>'form-control selectpicker','id'=>'unidadmedida'.$identificador,'data-live-search'=>'true'))}}
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label" for="lineabase{{$identificador}}">Linea Base</label>
                                <input type="text" class="form-control" id="lineabase{{$identificador}}" name="lineabase{{$identificador}}">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label" for="aniobase{{$identificador}}">Año Base</label>
                                <input type="text" class="form-control" id="aniobase{{$identificador}}" name="aniobase{{$identificador}}">
                            </div>
                        </div>
                    </div>
                </div>
