<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default datagrid" id="datagridComponentes" data-edit-row="editar">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <tr><td colspan="7" style="text-align:left"><i class="fa fa-info-circle"></i> No hay datos</td></tr>
                </tbody>
            </table>
