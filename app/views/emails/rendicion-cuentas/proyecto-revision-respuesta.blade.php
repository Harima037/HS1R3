                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                        <tr>
                                            <td valign="top" class="bodyContent" mc:edit="body_content">
                                                ...
                                                @if($estatus == 3)
                                                	<br>
                                                	<div style="color:#FFFFFF; background-color:#d9534f; font-weight:bold; text-align:center; vertical-align:middle; padding:10px;">
                                                		Se han encontrado errores en el avance capturado, por favor ingrese al sistema para corregirlos.
                                                	</div>
                                                @elseif($estatus == 4)
                                                	<br>
                                                ...
                                                @endif
                                                <br>
                                                <h3>Para ver una lista de los proyectos asignados a usted y su estatus en cuanto al seguimiento de metas haga click en el siguiente vinculo.</h3>
                                                <br />
                                                @if($proyecto->idClasificacionProyecto == 1)
                                                	<a href="{{URL::to('rendicion-cuentas/rend-cuenta-inst')}}">Click aqui para ver una lista de Proyectos Institucionales asignados a su cuenta</a>
                                                @else
                                                	<a href="{{URL::to('rendicion-cuentas/rend-cuenta-inv')}}">Click aqui para ver una lista de Proyectos de Inversión asignados a su cuenta</a>
                                                @endif
                                                <br />
												<br />
