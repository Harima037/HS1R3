...
<body class="cuerpo">
	<div class="header">
		<table>
			...
			<tr><td class="titulo3" align="center">PROGRAMA PRESUPUESTARIO {{$programa['ejercicio']}}</td></tr>
	...
	<table width="100%">
		<tr height="90" class="texto-medio texto">
			<td width="250px">Nombre del Programa Presupuestario : </td>
	...
	<table width="100%">
		...
		<tr class="negrita" height="20">
			<td></td>
			<td align="center">{{ $programa['responsableInformacion'] }}</td>
			<td></td>
			<td align="center">{{ $programa['liderPrograma'] }}</td>
			<td></td>
		</tr>
		<tr class="negrita" height="20">
			<td></td>
			<td align="center">{{ $programa['cargoResponsableInformacion'] }}</td>
			<td></td>
			<td align="center">{{ $programa['cargoLiderPrograma'] }}</td>
			<td></td>
		</tr>
	</table>
