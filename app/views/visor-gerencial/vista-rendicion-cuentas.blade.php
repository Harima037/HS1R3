	            ...
	            <table class="table table-striped table-hover">
	                <thead>
	                    <tr>
	                        ...
	                        <th>Nivel</th>
	                        <th>Indicador</th>
	                        <th class="text-center">Meta Anual<br>Programada</th>
	                        <th class="text-center">Meta al Mes<br>Acumulada</th>
	                        <th class="text-center">Avance<br>Acumulado</th>
							<th class="text-center">Avances<br>del Mes</th>
	                    </tr>
	                </thead>
	                <tbody>
