...
<script src="{{ URL::to('js/modulos/revision/revision-estrategia-institucional.js')}}"></script>
@stop
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default datagrid" id="datagridRevisionEstrategia" data-edit-row="cargar_datos_estrategia">
                            ...
                            @section('panel-botones')
                                <div class="btn-group" style="margin:5px">
                                	<button type="button" class="btn btn-success btn-edit-rows">
                                        <span class="glyphicon glyphicon-search"></span> Revisar estrategia Institucional
                                    </button>
                                </div>
                            @show
                        </div>
