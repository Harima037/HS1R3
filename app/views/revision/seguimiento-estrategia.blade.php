...
<script src="{{ URL::to('js/modulos/revision/lista-estrategia-rendicion.js') }}"></script>
@stop
                        ...
                        <div class="btn-toolbar pull-right" >
                            <div class="btn-group" style="margin:5px">
                                <button type="button" class="btn btn-success btn-edit-rows" id="btn-detalles-proyecto">
                                    <span class="fa fa-edit"></span> Ver Detalles de la Estrategia
                                </button>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <small><span class="text-muted" id="descripcion-cargo-responsable"></span></small>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
