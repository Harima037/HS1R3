...
@section('js')
@parent
<script src="{{ URL::to('js/modulos/demo/catalogo.js')}}"></script>
@stop
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default datagrid" id="datagridCatalogo" data-edit-row="editar">
                    ...
                    <div class="col-lg-6">
                        <div class="btn-toolbar pull-right" >
                            <div class="btn-group" style="margin:5px">
                                <button type="button" id="btnCatalogoAgregar" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Agregar</button>
...
@section('modals')
    <div class="modal fade" id="modalCatalogo" tabindex="-1" role="dialog" aria-labelledby="modalCatalogoLabel" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="modalCatalogoLabel">Nuevo Elemento</h4>
                </div>
                <div class="modal-body">
                    <form action="" id="formCatalogo">
                        <div class="row">
                            <div class="col-sm-12">
