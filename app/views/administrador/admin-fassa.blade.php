...
<script src="{{ URL::to('js/modulos/administrador/admin-fassa.js')}}"></script>
@stop
...
@section('modals')
<div class="modal fade" id="modalEditarIndicador" tabindex="-1" role="dialog" aria-labelledby="modalProyectoLabel" aria-hidden="true" data-backdrop="static">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <p class="form-control-static" id="nombre-indicador"></p>
                    </div>
                    <form action="" id="form_indicador">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="estatus-indicador" class="control-label">Estatus</label>
                                <select id="estatus-indicador" name="estatus-indicador" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <p class="form-control-static" id="formula"></p>
                                </div>
                            </div>
                            
                            <input type="hidden" id="indicador-id" value="">
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">Tipo Formula</label>
                                    <p class="form-control-static" id="tipo-formula"></p>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">Tasa</label>
                                    <p class="form-control-static" id="tasa"></p>
                                </div>
                            </div>
                        </div>    
                    </div>
